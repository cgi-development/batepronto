...
const FormConteudo = () => {
    <div className="form-conteudo">
        ...
        <Form id="formulario1" action="formulario-2.html" method="post" enctype="multipart/form-data">
            <div className="form-group">
                <Form.Control type="checkbox" className="mt-2" name="aceite" id="aceite"/>
                <Form.Label for="aceite">Aceito os termos e condições de uso</Form.Label>
            </div>
            <button className="btn btn-primary mt-2" id="botaoForm1">
